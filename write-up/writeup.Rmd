...
### Conclusion:
This project utilizes one of the most powerful visualization tools in R and every visualization plot can be set up by the user’s choices under different categories. In other words, the project focuses on user's interactive experience. Besides, each conclusion is driven by a data visualization manner instead of traditional statistical model. All in all, it provides a new direction to solve the same problem.
